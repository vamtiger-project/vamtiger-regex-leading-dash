...
describe("vamtiger-regex-leading-dash: regex.default", function () {
    it("should match a leading dash", function () {
        return __awaiter(this, void 0, void 0, function* () {
            const input = '-leadingDash', match = input.match(index_1.default), xMatch = XRegExp.exec(input, index_1.default);
